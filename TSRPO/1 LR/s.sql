...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 16 2017 г., 09:56
...
('root', '[{\"db\":\"plants\",\"table\":\"plantstable\"},{\"db\":\"plants\",\"table\":\"status\"},{\"db\":\"plants\",\"table\":\"reservation\"},{\"db\":\"plants\",\"table\":\"plants_reservation\"},{\"db\":\"plants\",\"table\":\"dddd\"},{\"db\":\"plants\",\"table\":\"PlantsTable\"}]');
...
('root', '2017-02-05 10:57:24', '{\"lang\":\"ru\",\"collation_connection\":\"utf8mb4_unicode_ci\"}');
...
-- База данных: `plants`
--
CREATE DATABASE IF NOT EXISTS `plants` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `plants`;

-- --------------------------------------------------------

--
-- Структура таблицы `plants_reservation`
--

CREATE TABLE `plants_reservation` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `plants_reservation`
--

INSERT INTO `plants_reservation` (`id`, `id_plant`, `id_reservation`) VALUES
(1, 1, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `plantstable`
--

CREATE TABLE `plantstable` (
  `id` int(11) NOT NULL,
  `rusname` varchar(2000) NOT NULL,
  `engname` varchar(2000) NOT NULL,
  `info` varchar(5000) NOT NULL,
  `secmeasures` varchar(5000) NOT NULL,
  `id_status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `plantstable`
--

INSERT INTO `plantstable` (`id`, `rusname`, `engname`, `info`, `secmeasures`, `id_status`) VALUES
(1, 'Мухомор', 'Muhomor', 'Вкусный гриб. Папа ел.', 'Не ешьте, будет плохо.', 1),
(2, 'Подорожник', 'Aboutroad', 'Помогает', 'Не рвите без надобности', 1);
...
INSERT INTO `reservation` (`id`, `name`) VALUES
(1, 'Заказник “Озеро Большой Тассор”.');
...
--
-- Индексы таблицы `plants_reservation`
--
ALTER TABLE `plants_reservation`
  ADD PRIMARY KEY (`id`),
  ADD KEY `plants_reservation_ibfk_1` (`id_plant`),
  ADD KEY `plants_reservation_ibfk_2` (`id_reservation`);

--
-- Индексы таблицы `plantstable`
--
ALTER TABLE `plantstable`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT для таблицы `plants_reservation`
--
ALTER TABLE `plants_reservation`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT для таблицы `plantstable`
--
ALTER TABLE `plantstable`
...
--
-- Ограничения внешнего ключа таблицы `plants_reservation`
--
ALTER TABLE `plants_reservation`
  ADD CONSTRAINT `plants_reservation_ibfk_1` FOREIGN KEY (`id_plant`) REFERENCES `plantstable` (`id`),
  ADD CONSTRAINT `plants_reservation_ibfk_2` FOREIGN KEY (`id_reservation`) REFERENCES `reservation` (`id`);

--
-- Ограничения внешнего ключа таблицы `plantstable`
--
ALTER TABLE `plantstable`
  ADD CONSTRAINT `plantstable_ibfk_1` FOREIGN KEY (`id_status`) REFERENCES `status` (`id`);
--
-- База данных: `test`
--
